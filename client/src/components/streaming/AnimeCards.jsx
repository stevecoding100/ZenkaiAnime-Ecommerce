    ...
    return (
        <>
            ...
            <div className="relative flex items-center group ">
                <div className="w-full h-full grid grid-cols-2 md:grid-cols-3  lg:grid-cols-6 gap-y-6 md:gap-y-4 mb-8 lg:p-2 relative">
                    {data.map((anime, id) => (
                        <div
                            key={id}
                            className=" w-[185px] md:w-[248px] lg:w-[228px] mx-auto cursor-pointer relative p-1"
                        >
