...
const Navbar = ({ pageType, searchProducts, token, setShowCart }) => {
    ...
    return (
        <div>
            <nav className="flex flex-col md:flex-row md:justify-between mt-4">
                <div className="flex justify-between items-center w-full p-6 md:w-auto">
                    ...
                    <div>
                        {token && pageType === "merchandise" && (
                            <div className="text-black ml-4 cursor-pointer flex items-center mx-auto">
                                <FaShoppingCart
                                    size={32}
                                    className="mr-12"
                                    onClick={toggleCart}
